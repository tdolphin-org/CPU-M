...
namespace DataInfo
{
    const std::map<GfxCardID, GfxCardSpec> gfxCard2spec {
        ...
        {
            GfxCardID::ATI_Radeon_X800_XT_AGP,
            { "Radeon X800 XT AGP",
              ManufacturerID::ATI,
              GPUID::ATI_R420,
              GPUVariantID::ATI_R420_XT,
              2004,
              { BoardInterface::AGP_8x },
              54,
              { { 8'000'000, 750'000, 8'000'000 } } },
        },
        {
            GfxCardID::ATI_Radeon_X800_XT,
            { "Radeon X800 XT",
              ManufacturerID::ATI,
              GPUID::ATI_R423,
              GPUVariantID::ATI_R423_XT,
              2004,
              { BoardInterface::PCIe_x16 },
              54,
              { { 8'000'000, 750'000, 8'000'000 } } },
        ...
        {
            GfxCardID::ATI_Radeon_X1050_AGP,
            { "Radeon X1050 AGP",
              ManufacturerID::ATI,
              GPUID::ATI_RV360,
              std::nullopt,
        ...
        },
        {
            ...
            { "Radeon X1050",
              ...
              { BoardInterface::PCIe_x16 },
              24,
              { { 3'200'000, 600'000, 3'200'000 } } },
        },
        {
            GfxCardID::ATI_Radeon_X1300,
            { "Radeon X1300",
              ManufacturerID::ATI,
              GPUID::ATI_RV515,
              GPUVariantID::ATI_RV515_LE,
              2005,
              { BoardInterface::AGP_8x },
              std::nullopt,
              { { 1'000'000, 125'000, 1'000'000 } } },
        ...
        {
            GfxCardID::ATI_Radeon_X1300_Pro,
            { "Radeon X1300 Pro",
              ManufacturerID::ATI,
              GPUID::ATI_RV516,
              GPUVariantID::ATI_RV516_PRO,
              2006,
              { BoardInterface::PCIe_x16 },
              31,
              { { 2'400'000, 300'000, 2'400'000 } } },
        },
        {
            GfxCardID::ATI_Radeon_X1550,
            { "Radeon X1550",
              ManufacturerID::ATI,
              GPUID::ATI_RV505,
              GPUVariantID::ATI_RV505_PRO,
              2007,
              { BoardInterface::PCIe_x16 },
              27,
              { { 2'000'000, 250'000, 2'000'000 } } },
        },
        {
            ...
            { "Radeon X1600",
              ...
              { BoardInterface::PCIe_x16 },
              27,
              { { 2'540'000, 317'500, 2'540'000 } } },
        },
        {
            GfxCardID::ATI_Radeon_X1600_Pro,
            { "Radeon X1600 Pro",
              ManufacturerID::ATI,
              GPUID::ATI_RV516,
              std::nullopt,
        ...
        },
        {
            ...
            { "Radeon HD 4350",
              ...
              { BoardInterface::PCIe_2_x16 },
              20,
              { { 2'400'000, std::nullopt, 4'800'000, 96'000'000, std::nullopt } } },
        },
        {
        ...
        {
            GfxCardID::AMD_Radeon_HD_5450,
            { "Radeon HD 5450",
              ManufacturerID::AMD,
              GPUID::AMD_CEDAR,
              GPUVariantID::AMD_CEDAR_PRO,
              2010,
              { BoardInterface::PCIe_2_x16 },
              19,
              { { 2'600'000, std::nullopt, 5'200'000, 104'000'000, std::nullopt } } },
        },
        {
