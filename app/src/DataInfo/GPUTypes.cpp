...
namespace std
{
    ...
    std::string to_string(const DataInfo::GPUVariantID &gpuVariantID)
    {
        ...
        static const std::map<GPUVariantID, std::string> gpuVariantIDMap = {
            { GPUVariantID::ATI_RV200_7500, "RV200 7500" },
            { GPUVariantID::ATI_RV200_7500_LE, "RV200 7500 LE" },
            { GPUVariantID::ATI_RV280_9200_SE, "RV280 9200 SE" },
            { GPUVariantID::ATI_RV350_LX, "RV350 LX" },
            { GPUVariantID::ATI_RV350_LE, "RV350 LE" },
            { GPUVariantID::ATI_RV350_SE, "RV350 SE" },
            { GPUVariantID::ATI_RV380_XT, "RV380 XT" },
            { GPUVariantID::ATI_R420_XT, "R420 XT" },
            { GPUVariantID::ATI_R423_XT, "R423 XT" },
            { GPUVariantID::ATI_RV505_PRO, "RV505 Pro" },
            { GPUVariantID::ATI_RV515_LE, "RV515 LE" },
            { GPUVariantID::ATI_RV516_PRO, "RV516 Pro" },
            { GPUVariantID::ATI_RV535_XT, "RV535 XT" },
            { GPUVariantID::ATI_RV570_XL, "RV570 XL" },
            { GPUVariantID::ATI_R580_PLUS_XT, "R580+ XT" },
            { GPUVariantID::ATI_RV620_LE, "RV620 LE" },
            { GPUVariantID::ATI_RV670_Pro, "RV670 Pro" },
            { GPUVariantID::ATI_RV730_XT, "RV730 XT" },
            { GPUVariantID::AMD_BARTS_XT, "Barts XT" },
            { GPUVariantID::AMD_KHALIDSTER, "Khalidster" },
            { GPUVariantID::AMD_CAICOS_XT, "Caicos XT" },
            { GPUVariantID::AMD_CAICOS_PRO, "Caicos Pro" },
            { GPUVariantID::AMD_CEDAR_PRO, "Cedar Pro" },
            { GPUVariantID::AMD_TURKS_LE, "Turks LE" },
            { GPUVariantID::AMD_TURKS_PRO, "Turks Pro" },
            { GPUVariantID::AMD_TURKS_PRO_L, "Turks PRO-L" },
            { GPUVariantID::AMD_REDWOOD_PRO, "Redwood Pro" },
            { GPUVariantID::AMD_BAFFIN_PRO, "Baffin Pro" },
